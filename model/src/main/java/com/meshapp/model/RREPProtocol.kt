...
object RREPProtocol {
    ...
    object PublicKey : Field<com.meshapp.model.PublicKey> {
        override fun read(data: ByteArray, baseOffset: Int): ReadWithLength<com.meshapp.model.PublicKey> =
            ReadWithLength(PublicKey(readBytes(data, baseOffset, PUBLIC_KEY_LENGTH)), PUBLIC_KEY_LENGTH)

        override fun write(data: ByteArray, value: com.meshapp.model.PublicKey, baseOffset: Int): Int {
